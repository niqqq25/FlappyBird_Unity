...
public static class ScreenUtils
{
    ...
    public static bool IsOffTopScreenY(GameObject gameObject)
    {
        float gameObjectHeight = gameObject.GetComponent<SpriteRenderer>().bounds.size.y;
        return gameObject.transform.position.y > ScreenTop + gameObjectHeight;
    }
